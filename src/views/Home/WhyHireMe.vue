...
<template>
  <div class="flex flex-col justify-center items-center gap-[5vh]">
    <h1
      class="font-[600] text-[30px] md:text-[48px] leading-[62px] text-[#151517]"
    >
      Why Hire Me?
    </h1>
    <div
    ...
    >
      ...
      >
        <img
          class="aspect-[240/313] md:w-full"
          :src="advantage.picture"
          :key="index"
        />
